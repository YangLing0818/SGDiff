...
from sgCLIP.create_model import create_model_and_transforms
from training.distributed import is_master, init_distributed_device, world_info_from_env
from training.logger import setup_logging
from training.configs import parse_args
from training.scheduler import cosine_lr
from training.train_mim import train_one_epoch, validate_one_epoch#, evaluate
from datasets.dataloader_builder import build_vg_loaders
...
def trainer():
    ...
    graph_vocab, train_dataloader, val_dataloader = build_vg_loaders(args)
